...
public partial class studentlogin : System.Web.UI.Page
{
    ...
    protected void loginb_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            String checkuser = "select count(*) from stulogin where Username='" + ulnamet.Text + "'";
            ...
            {
                conn.Open();
                String checkpass = "select password from stulogin where Password='" + ulpasst.Text + "'";
                ...
                {
                    Session["userstudent"] = ulnamet.Text;
                    Response.Write("<script>alert('password is corrent');</script>");
                    Response.Redirect("navigationforstudent.aspx");
                }
                else
                {
