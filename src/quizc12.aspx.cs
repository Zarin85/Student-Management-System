...
public partial class quizc12 : System.Web.UI.Page
{
    ...
    protected void uploadquiz_Click(object sender, EventArgs e)
    {
            ...
            || fileExtension.ToLower() == ".png" || fileExtension.ToLower() == ".bmp")
        {
            ...
            String insertquery = " insert into Quizc12(Name,Size,Image) values(@fname,@fsize,@fimage)";
    ...
    protected void uploadztten_Click(object sender, EventArgs e)
    {
            ...
            || fileExtension.ToLower() == ".png" || fileExtension.ToLower() == ".bmp")
        {
            ...
            String insertquery = " insert into Attendencec12(Name,Size,Image) values(@fname,@fsize,@fimage)";
