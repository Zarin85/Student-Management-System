<%@ Page Language="C#" AutoEventWireup="true" CodeFile="semestereee.aspx.cs" Inherits="semestereee" %>
    ...
    <table class="style1">
        ...
        <tr>
            ...
            <td class="style3">
                Semester</td>
            <td class="style4">
                <asp:Button ID="firstfirst" runat="server" onclick="eee11_Click" Text="1st Year 1st Semester" 
                    Width="175px" />
            </td>
            <td class="style4">
                <asp:Button ID="firstsecond" runat="server" onclick="eee12_Click" Text="1st Year 2nd Semester" 
                    Width="175px" />
            </td>
