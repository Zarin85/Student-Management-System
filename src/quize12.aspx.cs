...
public partial class quize12 : System.Web.UI.Page
{
    ...
    protected void uploadquiz_Click(object sender, EventArgs e)
    {
            ...
            || fileExtension.ToLower() == ".png" || fileExtension.ToLower() == ".bmp")
        {
            ...
            String insertquery = " insert into Quize11(Name,Size,Image) values(@fname,@fsize,@fimage)";
    ...
    protected void uploadztten_Click(object sender, EventArgs e)
    {
            ...
            || fileExtension.ToLower() == ".png" || fileExtension.ToLower() == ".bmp")
        {
            ...
            String insertquery = " insert into Attendencece11(Name,Size,Image) values(@fname,@fsize,@fimage)";
