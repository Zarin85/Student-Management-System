<%@ Page Language="C#" AutoEventWireup="true" CodeFile="navigationforstudent.aspx.cs" Inherits="navigationforstudent" %>
 ...
 <td class="style25"><asp:Label ID="Label9" runat="server" Text="ID" ForeColor="Black" Font-Bold="true"></asp:Label>  &nbsp;&nbsp;   <asp:Label ID="Label2" runat="server" Text="Label"></asp:Label>      
   ...
   <tr>   <td class="style26"> 
    <asp:Label ID="Label13" runat="server" Text="DEPARTMENT NAME" ForeColor="Black" Font-Bold="true"></asp:Label> &nbsp;&nbsp;   <asp:Label ID="Label6" runat="server" Text="Label"></asp:Label>
     ...
     <tr>   <td class="style26"> 
    <asp:Label ID="Label14" runat="server" Text="Year" ForeColor="Black" Font-Bold="true"></asp:Label> &nbsp;&nbsp;   <asp:Label ID="Label15" runat="server" Text="Label"></asp:Label>
    </td> </tr>  
    <tr>   <td class="style26"> 
    <asp:Label ID="Label16" runat="server" Text="Course" ForeColor="Black" Font-Bold="true"></asp:Label> &nbsp;&nbsp;   <asp:Label ID="Label17" runat="server" Text="Label"></asp:Label>
    </td> </tr> 
    <tr>  <td class="style29">
